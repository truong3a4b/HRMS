...
mixin _$EmployeeDto {
 ...
 String get id; String get employeeId; String get name; String get email; String? get phone; String? get avatar; String get status; DateTime? get dateOfBirth; String? get gender; String? get address; DateTime? get hireDate; String? get salary; String? get bankAccount; String? get bankCode; String? get maritalStatus; String? get nationality; String? get religion; String? get identityCardNumber; DateTime? get identityCardIssueDate; String? get frontIdentityCardImage; String? get backIdentityCardImage; String? get provinceCode; String? get wardCode; String? get userId; String? get departmentId; String? get positionId; DateTime? get createdAt; DateTime? get updatedAt; UserDto? get user; DepartmentDto? get department; PositionDto? get position;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,employeeId,name,email,phone,avatar,status,dateOfBirth,gender,address,hireDate,salary,bankAccount,bankCode,maritalStatus,nationality,religion,identityCardNumber,identityCardIssueDate,frontIdentityCardImage,backIdentityCardImage,provinceCode,wardCode,userId,departmentId,positionId,createdAt,updatedAt,user,department,position]);

@override
String toString() {
  return 'EmployeeDto(id: $id, employeeId: $employeeId, name: $name, email: $email, phone: $phone, avatar: $avatar, status: $status, dateOfBirth: $dateOfBirth, gender: $gender, address: $address, hireDate: $hireDate, salary: $salary, bankAccount: $bankAccount, bankCode: $bankCode, maritalStatus: $maritalStatus, nationality: $nationality, religion: $religion, identityCardNumber: $identityCardNumber, identityCardIssueDate: $identityCardIssueDate, frontIdentityCardImage: $frontIdentityCardImage, backIdentityCardImage: $backIdentityCardImage, provinceCode: $provinceCode, wardCode: $wardCode, userId: $userId, departmentId: $departmentId, positionId: $positionId, createdAt: $createdAt, updatedAt: $updatedAt, user: $user, department: $department, position: $position)';
}
...
/// Create a copy of EmployeeDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? employeeId = null,Object? name = null,Object? email = null,Object? phone = freezed,Object? avatar = freezed,Object? status = null,Object? dateOfBirth = freezed,Object? gender = freezed,Object? address = freezed,Object? hireDate = freezed,Object? salary = freezed,Object? bankAccount = freezed,Object? bankCode = freezed,Object? maritalStatus = freezed,Object? nationality = freezed,Object? religion = freezed,Object? identityCardNumber = freezed,Object? identityCardIssueDate = freezed,Object? frontIdentityCardImage = freezed,Object? backIdentityCardImage = freezed,Object? provinceCode = freezed,Object? wardCode = freezed,Object? userId = freezed,Object? departmentId = freezed,Object? positionId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? user = freezed,Object? department = freezed,Object? position = freezed,}) {
...
switch (_that) {
case _EmployeeDto() when $default != null:
return $default(_that.id,_that.employeeId,_that.name,_that.email,_that.phone,_that.avatar,_that.status,_that.dateOfBirth,_that.gender,_that.address,_that.hireDate,_that.salary,_that.bankAccount,_that.bankCode,_that.maritalStatus,_that.nationality,_that.religion,_that.identityCardNumber,_that.identityCardIssueDate,_that.frontIdentityCardImage,_that.backIdentityCardImage,_that.provinceCode,_that.wardCode,_that.userId,_that.departmentId,_that.positionId,_that.createdAt,_that.updatedAt,_that.user,_that.department,_that.position);case _:
  return orElse();
...
class _EmployeeDto implements EmployeeDto {
  const _EmployeeDto({required this.id, required this.employeeId, required this.name, required this.email, this.phone, this.avatar, required this.status, this.dateOfBirth, this.gender, this.address, this.hireDate, this.salary, this.bankAccount, this.bankCode, this.maritalStatus, this.nationality, this.religion, this.identityCardNumber, this.identityCardIssueDate, this.frontIdentityCardImage, this.backIdentityCardImage, this.provinceCode, this.wardCode, this.userId, this.departmentId, this.positionId, this.createdAt, this.updatedAt, this.user, this.department, this.position});
...
@override $UserDtoCopyWith<$Res>? get user;@override $DepartmentDtoCopyWith<$Res>? get department;@override $PositionDtoCopyWith<$Res>? get position;
