...
as List<InterviewEvaluationDto>,offers: null == offers ? _self.offers : offers // ignore: cast_nullable_to_non_nullable
as List<OfferDto>,
  ));
}
/// Create a copy of JobApplicationDto
...
class _JobApplicationDto implements JobApplicationDto {
  const _JobApplicationDto({required this.id, this.candidateId, this.recruitmentJobId, this.positionId, this.departmentId, this.candidateAvatar, this.candidateName, this.candidateEmail, this.candidatePhone, this.candidateAddress, this.candidateGender, this.candidateBirthDate, this.candidateCvUrl, required this.status, this.proposedSalary, this.proposedHireDate, this.coverLetter, this.notes, required this.appliedAt, this.updatedAt, this.rejectedAt, this.cancelledAt, this.offerSentAt, this.offerRespondedAt, this.onboardedAt, required this.position, required this.department, required this.recruitmentJob, final  List<InterviewScheduleDto> interviewSchedules = const [], final  List<InterviewEvaluationDto> evaluations = const [], final  List<OfferDto> offers = const []}): _interviewSchedules = interviewSchedules,_evaluations = evaluations,_offers = offers;
...
@override@JsonKey() List<InterviewEvaluationDto> get evaluations {
 ...
 final  List<OfferDto> _offers;
@override@JsonKey() List<OfferDto> get offers {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _JobApplicationDto&&(identical(other.id, id) || other.id == id)&&(identical(other.candidateId, candidateId) || other.candidateId == candidateId)&&(identical(other.recruitmentJobId, recruitmentJobId) || other.recruitmentJobId == recruitmentJobId)&&(identical(other.positionId, positionId) || other.positionId == positionId)&&(identical(other.departmentId, departmentId) || other.departmentId == departmentId)&&(identical(other.candidateAvatar, candidateAvatar) || other.candidateAvatar == candidateAvatar)&&(identical(other.candidateName, candidateName) || other.candidateName == candidateName)&&(identical(other.candidateEmail, candidateEmail) || other.candidateEmail == candidateEmail)&&(identical(other.candidatePhone, candidatePhone) || other.candidatePhone == candidatePhone)&&(identical(other.candidateAddress, candidateAddress) || other.candidateAddress == candidateAddress)&&(identical(other.candidateGender, candidateGender) || other.candidateGender == candidateGender)&&(identical(other.candidateBirthDate, candidateBirthDate) || other.candidateBirthDate == candidateBirthDate)&&(identical(other.candidateCvUrl, candidateCvUrl) || other.candidateCvUrl == candidateCvUrl)&&(identical(other.status, status) || other.status == status)&&(identical(other.proposedSalary, proposedSalary) || other.proposedSalary == proposedSalary)&&(identical(other.proposedHireDate, proposedHireDate) || other.proposedHireDate == proposedHireDate)&&(identical(other.coverLetter, coverLetter) || other.coverLetter == coverLetter)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.appliedAt, appliedAt) || other.appliedAt == appliedAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.rejectedAt, rejectedAt) || other.rejectedAt == rejectedAt)&&(identical(other.cancelledAt, cancelledAt) || other.cancelledAt == cancelledAt)&&(identical(other.offerSentAt, offerSentAt) || other.offerSentAt == offerSentAt)&&(identical(other.offerRespondedAt, offerRespondedAt) || other.offerRespondedAt == offerRespondedAt)&&(identical(other.onboardedAt, onboardedAt) || other.onboardedAt == onboardedAt)&&(identical(other.position, position) || other.position == position)&&(identical(other.department, department) || other.department == department)&&(identical(other.recruitmentJob, recruitmentJob) || other.recruitmentJob == recruitmentJob)&&const DeepCollectionEquality().equals(other._interviewSchedules, _interviewSchedules)&&const DeepCollectionEquality().equals(other._evaluations, _evaluations)&&const DeepCollectionEquality().equals(other._offers, _offers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,candidateId,recruitmentJobId,positionId,departmentId,candidateAvatar,candidateName,candidateEmail,candidatePhone,candidateAddress,candidateGender,candidateBirthDate,candidateCvUrl,status,proposedSalary,proposedHireDate,coverLetter,notes,appliedAt,updatedAt,rejectedAt,cancelledAt,offerSentAt,offerRespondedAt,onboardedAt,position,department,recruitmentJob,const DeepCollectionEquality().hash(_interviewSchedules),const DeepCollectionEquality().hash(_evaluations),const DeepCollectionEquality().hash(_offers)]);
...
as List<InterviewEvaluationDto>,offers: null == offers ? _self._offers : offers // ignore: cast_nullable_to_non_nullable
as List<OfferDto>,
  ));
}
