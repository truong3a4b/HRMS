...
mixin _$RecruitmentJobDto {
 ...
 String get id; String get title; String get description; String get requirements; String get benefits; String? get salaryMin; String? get salaryMax; int get quantity; DateTime? get deadline; String get status; String? get positionId; String? get departmentId; PositionDto? get position; DepartmentDto? get department; DateTime? get createdAt; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,requirements,benefits,salaryMin,salaryMax,quantity,deadline,status,positionId,departmentId,position,department,createdAt,updatedAt);

@override
String toString() {
  return 'RecruitmentJobDto(id: $id, title: $title, description: $description, requirements: $requirements, benefits: $benefits, salaryMin: $salaryMin, salaryMax: $salaryMax, quantity: $quantity, deadline: $deadline, status: $status, positionId: $positionId, departmentId: $departmentId, position: $position, department: $department, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String title, String description, String requirements, String benefits, String? salaryMin, String? salaryMax, int quantity, DateTime? deadline, String status, String? positionId, String? departmentId, PositionDto? position, DepartmentDto? department, DateTime? createdAt, DateTime? updatedAt
});
...
/// Create a copy of RecruitmentJobDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = null,Object? requirements = null,Object? benefits = null,Object? salaryMin = freezed,Object? salaryMax = freezed,Object? quantity = null,Object? deadline = freezed,Object? status = null,Object? positionId = freezed,Object? departmentId = freezed,Object? position = freezed,Object? department = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
switch (_that) {
case _RecruitmentJobDto() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.requirements,_that.benefits,_that.salaryMin,_that.salaryMax,_that.quantity,_that.deadline,_that.status,_that.positionId,_that.departmentId,_that.position,_that.department,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _RecruitmentJobDto implements RecruitmentJobDto {
  const _RecruitmentJobDto({required this.id, required this.title, required this.description, required this.requirements, required this.benefits, this.salaryMin, this.salaryMax, required this.quantity, this.deadline, required this.status, this.positionId, this.departmentId, this.position, this.department, this.createdAt, this.updatedAt});
...
/// Create a copy of RecruitmentJobDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? description = null,Object? requirements = null,Object? benefits = null,Object? salaryMin = freezed,Object? salaryMax = freezed,Object? quantity = null,Object? deadline = freezed,Object? status = null,Object? positionId = freezed,Object? departmentId = freezed,Object? position = freezed,Object? department = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
